module Constants
  ...
  module WeaponTypes
    ...
    SIMPLE_WEAPON_TYPES = [CLUB, DAGGER, GREAT_CLUB, HAND_AXE, JAVELIN, LIGHT_HAMMER, MACE, QUARTERSTAFF,
                           SICKLE, SPEAR, UNARMED_STRIKE, LIGHT_CROSSBOW, DART, SHORT_BOW, SLING].freeze
    ...
    WEAPON_TYPES = [CLUB, DAGGER, GREAT_CLUB, HAND_AXE, JAVELIN, LIGHT_HAMMER, MACE, QUARTERSTAFF,
                    SICKLE, SPEAR, UNARMED_STRIKE, LIGHT_CROSSBOW, DART, SHORT_BOW, SLING, BATTLE_AXE,
  ...
  module DamageTypes
    ...
    DAMAGE_TYPES          = [BLUDGEONING, PIERCING, SLASHING, ACID, COLD, FIRE, FORCE, LIGHTNING, NECROTIC, POISON,
                             PSYCHIC, RADIANT, THUNDER].freeze
  end
  ...
  module UserRoles
    ...
    USER_ROLES = [FREE, ADMIN, SUBSCRIBER].freeze
  end
end
